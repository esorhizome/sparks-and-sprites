...
const SCENES := [
	...
	"cube_vfx", "text_fx", "locomotion", "flipbook", "flipbook_vfx", "depth", "depth_wire_3d",
	"stagecraft", "worlds",
]
const PAGED := ["elemental_buttons", "cube_vfx", "text_fx", "locomotion", "flipbook", "depth", "stagecraft", "worlds"]   # these page through their families
